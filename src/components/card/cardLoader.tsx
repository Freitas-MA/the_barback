const CardLoader = () => {
	...
	return (
		<div className="flex flex-col bg-neutral-200 justify-between text-center items-center gap-2 w-[15rem] h-[18rem] animate-pulse rounded-md shadow-md p-4 m-4 hover:shadow-lg relative">
