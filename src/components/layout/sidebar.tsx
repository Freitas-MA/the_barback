...
export default async function UserAppSidebar({
	...
	return (
		<nav className="md:flex md:max-w-[300px] md:min-h-[89vh] md:justify-start md:items-start md:relative md:bg-slate-100 fixed bottom-0 left-0 z-30 shadow-lg flex-row items-center justify-between w-screen bg-slate-300 bg-opacity-90">
